breed_characteristics = {
    ...
    "Cairn Terrier":
        {1: "Description\nIt is a small-sized, sturdy dog with short legs. It has a flat head, a pronounced stop, a strong muzzle and a black nose. The eyes are wide apart, hazel and covered with bushy eyebrows. The ears are small, triangular, slightly slating, pointy and erect. The tail is short, pointy at the tip covered in hair and carried vertically. The fur is double-layered, with soft and fluffy inner layer and an outer layer made of thick, rough, not too short, straight hair. The coat can have any colour except white and has darker shades on the ears, muzzle and the tip of the tail.",
         ...
         4: "Living situation\nIt is a dog that can adapt rather easily both to outdoor life, being resistant to weather changes and to life in a flat with an active family and with the possibility of exercising and getting daily walks. It needs socialization and training.",
         5: "Training\This dog is relatively easy to train because it is intelligent, likes to learn and to work. It needs a rigorous, firm, consistent training done in a gentle and calm voice and it shouldn't be let to do what it wants. It should be socialized from an early age with other household animals and other dogs. It likes exercise and running in open spaces. It must be taught to come to its master when called, because of its hunting instincts that can make it run away.",
         6: "Usefulness\nIt is a very good hunter of rodents and small wild animals. It is a perfect companion for a sportive family."},
